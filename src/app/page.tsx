    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-2xl z-10">
        {/* Pushup */}
          ...
          href="/pushup"
          className="group relative h-72 rounded-2xl overflow-hidden flex flex-col justify-end p-7 transition-transform duration-300 hover:-translate-y-1.5 active:scale-[0.97]"
        ...
        >
          ...
          <span
            ...
            style={{ fontFamily: "'Bebas Neue', cursive", fontSize: 38, letterSpacing: "0.04em", color: "#0f0f0f" }}
          >
            Pushups
          </span>
          <span
            className="relative z-10 mt-1.5 text-xs uppercase tracking-[0.12em]"
            style={{ color: "#999" }}
          >
            Strength &amp; Power
          </span>
        ...
        >
          ...
          <span
            className="relative z-10 block leading-none"
            style={{ fontFamily: "'Bebas Neue', cursive", fontSize: 38, letterSpacing: "0.04em", color: "#fff" }}
          >
            Pilates
          </span>
          <span
      ...
      {/* Footer */}
      <p
        className="mt-10 text-[10px] font-medium uppercase tracking-[0.3em] z-10"
        style={{ color: "#2a2a2a" }}
      >
